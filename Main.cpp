...
int main()
{
    // Station source = Station("Mumbai");
    // Station dest = Station("Delhi");
    ...
    // cout<<source.GetDistance(dest)<<endl;
    // cout<<dest.GetDistance(source)<<endl;

    // Date d = Date(10, 12, 2012);
    // cout<<d;

    // const BookingClasses &a = Sleeper::Type();
    // cout<<a;

    // Passenger p("Kaushal", 1234567, Date(10, 12, 2012), "male", 8689899559, "General");
    // cout<<p;
